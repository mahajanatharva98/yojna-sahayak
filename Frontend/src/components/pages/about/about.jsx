      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
                { name: "Mr. Atharva Mahajan", role: "Tech Lead", bio: "Student" },
                { name: "Mr. Rushikesh Patil ", role: "Data Analyst", bio: "Student" },
              { name: " Mr. Prasad Reshim", role: "Policy Expert", bio: "Student" },
              { name: "Mr. Sai Bhor", role: "Community Outreach", bio: "Student" },
            ].map((member, index) => (
